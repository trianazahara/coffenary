...
const Sidebar = () => {
  ...
  const styles = {
    sidebar: {
      width: '250px',
      background: 'linear-gradient(180deg, #065f46 0%, #059669 60%, #b08968 100%)',
      color: '#f0fdf4',
      display: 'flex',
  ...
  const handleChangeBranch = () => navigate('/pilih-cabang');
  ...
  return (
    <aside style={styles.sidebar}>
      ...
      >
        <Building
          size={20}
          style={{ marginRight: '0.75rem', color: '#fef3c7', flexShrink: 0 }}
        />
        <span
          style={{
            color: 'white',
